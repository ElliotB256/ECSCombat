...
//        ]
//    public class ShieldsBlockProjectilesSystem : JobComponentSystem
//    {
//        EntityQuery Attacks;
...
//        [BurstCompile]
//        struct CollectShieldHitsJob : IJobForEachWithEntity<Projectile, LocalToWorld, Target, Speed>
//        {
...
//                // Projectile hits shield if within radius.
//                var delta = localToWorld.Position - targetPosition.Position;
//                //if (math.lengthsq(delta) < math.pow(shield.Radius, 2.0f))

//                // Ahh this is difficult!
//                //  -What if a projectile is fired _from within_ the shield?
//                //  -Can't just check whether projectile will cross shield boundary. Some would slip under, because the shielded ship is also moving.
//                //  -This would disproportionately affect slower moving projectiles. Perhaps this could be a 'feature'?
//            }
//        }
